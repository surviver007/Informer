...
parser.add_argument('--root_path', type=str, default='./data/TimeSeriesData/', help='root path of the data file')
...
data_parser = {
    ...
    'Stock': {'data': 'Stock.csv', 'T': 'Label', 'M': [52, 52, 52], 'S': [1, 1, 1], 'MS': [52, 52, 1]}
}
